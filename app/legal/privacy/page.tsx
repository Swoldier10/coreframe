export default function PrivacyPage() {
    return (
        <>
            ...
            <address className="not-italic bg-white p-6 border border-gray-200 rounded-lg text-sm">
                <strong>Coreframe Digital Agency</strong><br />
                [Street Address]<br />
                [City, Postal Code]<br />
                [Country]<br />
                Email: <a href="mailto:legal@coreframe.digital">legal@coreframe.digital</a>
            </address>
            ...
            <p>
                <strong>Coreframe Digital Agency</strong><br />
                <a href="mailto:legal@coreframe.digital">legal@coreframe.digital</a>
            </p>
        </>
    );
}
